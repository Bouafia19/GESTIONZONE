...
/*loading the overlays from GeoServer.web_map is the workspace name. Loading the layer as a WMS*/
  var nairobi_county = new OpenLayers.Layer.WMS (
        "Nairobi County",
        "http://localhost:8080/geoserver/states/wms",
        {layers:"states:nairobi_county",transparent: true, format: "image/gif"},
        {visibility: true},
 ...
 var completed = new OpenLayers.Layer.WMS (
        "Completed",
        "http://localhost:8080/geoserver/states/wms",
        {layers:"states:completed",transparent: true, format: "image/gif"},
        {visibility: false},
        {'displayInLayerSwitcher':true}
);
